...
import io.github.MoWei.Frozen.ManagerCmd;
...
public class Settings extends AppCompatActivity implements View.OnClickListener {
    ...
    final int BootFreezeIdx = 16;
    final int BinderFreezerIdx = 17;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.BootFreeze_title).setOnClickListener(this);
        ...
        BootFreezeSwitch = findViewById(R.id.switch_BootFreeze);
        BinderFreezerSwitch = findViewById(R.id.switch_BinderFreezer);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case INIT_UI:
                    ...
                    InitSwitch(BootFreezeSwitch, BootFreezeIdx);
                    InitSwitch(BinderFreezerSwitch, BinderFreezerIdx);
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.BootFreeze_title) {
            Utils.textDialog(this, R.string.boot_freeze_title, R.string.boot_freeze_tips);
        } else if (id == R.id.BinderFreezer_title) {
            Utils.textDialog(this, R.string.BinderFreezer_title, R.string.BinderFreezer_tips);
        } else if (id == R.id.MemoryReclaim_title) {
            Utils.textDialog(this, R.string.MemoryReclaim_title, R.string.MemoryReclaim_tips);
        } else if (id == R.id.ClearBettryWhllelist_title) {
